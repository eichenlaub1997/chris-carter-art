...
class ProductProvider extends Component {
	//write functions in here starting with the state variable 
	...
	render() {
		return (
			<ProductContext.Provider 
				value={{
					// all of our functions are placed in here
					// as well as outside of this tag
					// Form => functionName:this.functionName,
